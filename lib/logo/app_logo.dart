...
class _AppLogoState extends State<AppLogo> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    super.initState(); // Start the animation
  }
  ...
  Widget build(BuildContext context) {
    final rotationTween = Tween<double>(begin:  360 * pi*2 / 180, end: 0);
    final rotationTweenm = Tween<double>(begin:  0, end: 360 * pi*2 / 180);
                      ...
                      Positioned(
                        ...
                        child: Transform.rotate(
                          ...
                          child: AnimatedBuilder(
                            ...
                            angle:
                            rotationTweenm.evaluate(animationController!)
                                ,
                            child: Container(
                              width: 18,
                              height: 90,
